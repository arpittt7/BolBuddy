  ...
  en: {
    ...
    home: {
        ...
        features: {
            ...
            careerExplorer: {
                title: 'Find Your Path with Career Explorer',
                subtitle: "Not sure what to do after 12th? We've got your back.",
                item1: 'Discover careers based on your interests',
                item2: 'Follow step-by-step roadmaps (like "How to become a Web Developer")',
                item3: "Listen to real stories from seniors & mentors who've been there",
                cta: 'Start exploring — your future begins here.',
  ...
  hi: {
    ...
    home: {
        ...
        features: {
            ...
            careerExplorer: {
                title: 'करियर एक्सप्लोरर के साथ अपना रास्ता खोजें',
                subtitle: "12वीं के बाद क्या करें, समझ नहीं आ रहा? हम आपके साथ हैं।",
                item1: 'अपनी रुचियों के आधार पर करियर खोजें',
                item2: 'चरण-दर-चरण रोडमैप का पालन करें (जैसे "वेब डेवलपर कैसे बनें")',
                item3: "वहाँ रहे सीनियर्स और मेंटर्स की असली कहानियाँ सुनें",
                cta: 'खोज शुरू करें - आपका भविष्य यहीं से शुरू होता है।',
                button: 'खोज शुरू करें'
            }
        }
    },
    bolbuddy: {
  ...
  te: {
    ...
    home: {
      ...
      features: {
        ...
        careerExplorer: {
            title: 'కెరీర్ ఎక్స్‌ప్లోరర్‌తో మీ మార్గాన్ని కనుగొనండి',
            subtitle: "12వ తరగతి తర్వాత ఏమి చేయాలో ఖచ్చితంగా తెలియదా? మేము మీకు అండగా ఉన్నాము.",
            item1: 'మీ ఆసక్తుల ఆధారంగా కెరీర్‌లను కనుగొనండి',
            item2: 'దశల వారీ రోడ్‌మ్యాప్‌లను అనుసరించండి (ఉదాహరణకు "వెబ్ డెవలపర్ ఎలా అవ్వాలి")',
            item3: "అక్కడ ఉన్న సీనియర్లు & మార్గదర్శకుల నుండి నిజమైన కథలను వినండి",
            cta: 'అన్వేషించడం ప్రారంభించండి — మీ భవిష్యత్తు ఇక్కడ ప్రారంభమవుతుంది.',
            button: 'అన్వేషించడం ప్రారంభించండి'
        }
      }
    },
    bolbuddy: {
  ...
  ta: {
    ...
    home: {
      ...
      features: {
        ...
        careerExplorer: {
            title: 'தொழில் எக்ஸ்ப்ளோரருடன் உங்கள் பாதையைக் கண்டறியுங்கள்',
            subtitle: "12 ஆம் வகுப்புக்குப் பிறகு என்ன செய்வதென்று தெரியவில்லையா? நாங்கள் உங்களுக்கு ஆதரவாக இருக்கிறோம்.",
            item1: 'உங்கள் ஆர்வங்களின் அடிப்படையில் தொழில்களைக் கண்டறியுங்கள்',
            item2: 'படிப்படியான சாலை வரைபடங்களைப் பின்பற்றவும் (உதாரணமாக "ஒரு வலை உருவாக்குநர் ஆவது எப்படி")',
            item3: "அங்கு இருந்த மூத்தவர்கள் மற்றும் வழிகாட்டிகளிடமிருந்து உண்மைக் கதைகளைக் கேளுங்கள்",
            cta: 'ஆராய்வதைத் தொடங்குங்கள் — உங்கள் எதிர்காலம் இங்கே தொடங்குகிறது.',
            button: 'ஆராய்வதைத் தொடங்குங்கள்'
        }
      }
    },
    bolbuddy: {
  ...
  mr: {
    ...
    home: {
      ...
      features: {
        ...
        careerExplorer: {
            title: 'करिअर एक्सप्लोररसह आपला मार्ग शोधा',
            subtitle: "12वी नंतर काय करावे याची खात्री नाही? आम्ही तुमच्या पाठीशी आहोत.",
            item1: 'आपल्या आवडीनुसार करिअर शोधा',
            item2: 'पायरी-पायरी रोडमॅपचे अनुसरण करा (जसे की "वेब डेव्हलपर कसे व्हावे")',
            item3: "तेथे असलेल्या वरिष्ठ आणि मार्गदर्शकांच्या खऱ्या कथा ऐका",
            cta: 'शोध सुरू करा — तुमचे भविष्य येथे सुरू होते.',
            button: 'शोध सुरू करा'
        }
      },
    },
