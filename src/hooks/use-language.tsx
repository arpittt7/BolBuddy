...
const translations = {
  en: {
    ...
    home: {
        ...
        about: {
            title: 'About BolBuddy',
            description: 'BolBuddy is a platform designed to bridge the gap for students in rural India, providing them with access to mentorship, peer support, and valuable resources. Our mission is to empower every student, regardless of their background, to achieve their dreams and build a successful future. Through AI-powered mentor matching, anonymous Q&A, and community-driven learning, we aim to create a supportive ecosystem where every voice is heard and every goal is within reach.'
        }
    },
    bolbuddy: {
  ...
  hi: {
    ...
    home: {
        ...
        about: {
            title: 'बोलबडी के बारे में',
            description: 'बोलबडी एक ऐसा मंच है जिसे ग्रामीण भारत में छात्रों के लिए अंतर को पाटने के लिए डिज़ाइन किया गया है, जो उन्हें मार्गदर्शन, सहकर्मी सहायता और मूल्यवान संसाधनों तक पहुँच प्रदान करता है। हमारा मिशन हर छात्र को सशक्त बनाना है, चाहे उनकी पृष्ठभूमि कुछ भी हो, ताकि वे अपने सपनों को प्राप्त कर सकें और एक सफल भविष्य का निर्माण कर सकें। एआई-संचालित मेंटर मैचिंग, अनाम प्रश्नोत्तर और समुदाय-संचालित सीखने के माध्यम से, हम एक सहायक पारिस्थितिकी तंत्र बनाने का लक्ष्य रखते हैं जहाँ हर आवाज़ सुनी जाती है और हर लक्ष्य पहुँच के भीतर होता है।'
        }
    },
    bolbuddy: {
  ...
  te: {
    ...
    home: {
      ...
      about: {
        title: 'బోల్‌బడ్డీ గురించి',
        description: 'బోల్‌బడ్డీ అనేది గ్రామీణ భారతదేశంలోని విద్యార్థుల కోసం అంతరాన్ని తగ్గించడానికి రూపొందించిన ఒక వేదిక, ఇది వారికి మార్గదర్శకత్వం, తోటివారి మద్దతు మరియు విలువైన వనరులను అందిస్తుంది. మా లక్ష్యం ప్రతి విద్యార్థికి, వారి నేపథ్యంతో సంబంధం లేకుండా, వారి కలలను సాధించడానికి మరియు విజయవంతమైన భవిష్యత్తును నిర్మించడానికి అధికారం ఇవ్వడం. AI-ఆధారిత మార్గదర్శక సరిపోలిక, అనామక ప్రశ్నోత్తరాలు మరియు సంఘం-ఆధారిత అభ్యాసం ద్వారా, ప్రతి స్వరం వినబడే మరియు ప్రతి లక్ష్యం అందుబాటులో ఉండే ఒక సహాయక పర్యావరణ వ్యవస్థను సృష్టించడం మా లక్ష్యం.'
      }
    },
    bolbuddy: {
  ...
  ta: {
    ...
    home: {
      ...
      features: {
        ...
        about: {
            title: 'போல்buddy பற்றி',
            description: 'போல்buddy என்பது கிராமப்புற இந்தியாவில் உள்ள மாணவர்களுக்கான இடைவெளியைக் குறைக்க வடிவமைக்கப்பட்ட ஒரு தளமாகும், இது அவர்களுக்கு வழிகாட்டுதல், சக ஆதரவு மற்றும் மதிப்புமிக்க ஆதாரங்களுக்கான அணுகலை வழங்குகிறது. எங்கள் நோக்கம் ஒவ்வொரு மாணவருக்கும், அவர்களின் பின்னணியைப் பொருட்படுத்தாமல், அவர்களின் கனவுகளை அடையவும் வெற்றிகரமான எதிர்காலத்தை உருவாக்கவும் அதிகாரம் அளிப்பதாகும். AI-இயங்கும் வழிகாட்டி பொருத்தம், அநாமதேய கேள்வி பதில் மற்றும் சமூகத்தால் இயக்கப்படும் கற்றல் மூலம், ஒவ்வொரு குரலும் கேட்கப்படும் மற்றும் ஒவ்வொரு இலக்கும் அடையக்கூடிய ஒரு ஆதரவான சுற்றுச்சூழல் அமைப்பை உருவாக்குவதை நாங்கள் நோக்கமாகக் கொண்டுள்ளோம்.'
        }
    },
    bolbuddy: {
  ...
  mr: {
    ...
    home: {
      ...
      about: {
        title: 'बोलबडीबद्दल',
        description: 'बोलबडी हे ग्रामीण भारतातील विद्यार्थ्यांसाठी अंतर कमी करण्यासाठी डिझाइन केलेले एक व्यासपीठ आहे, जे त्यांना मार्गदर्शन, समवयस्क समर्थन आणि मौल्यवान संसाधनांमध्ये प्रवेश प्रदान करते. आमचे ध्येय प्रत्येक विद्यार्थ्याला, त्यांची पार्श्वभूमी काहीही असो, त्यांची स्वप्ने साध्य करण्यासाठी आणि यशस्वी भविष्य घडवण्यासाठी सक्षम करणे आहे. एआय-चालित मार्गदर्शक जुळणी, अनामिक प्रश्नोत्तर आणि समुदाय-चालित शिक्षणाद्वारे, आम्ही एक सहाय्यक परिसंस्था तयार करण्याचे ध्येय ठेवतो जिथे प्रत्येक आवाज ऐकला जातो आणि प्रत्येक ध्येय आवाक्यात असते.'
      }
    },
    bolbuddy: {
